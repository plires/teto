...
<body>
	...
	<section id="app" class="home">
		...
		<section class="container-fluid materiales_sustentables">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 content_img">
						<img
							data-aos="fade-up" 
							class="img-fluid" 
							src="<?= BASE ?>img/home/icono-materiales-sustentables.gif" 
							alt="materiales sustentables cielorraso teto vinilico depisos">
					</div>
